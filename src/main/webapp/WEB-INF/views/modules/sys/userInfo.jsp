...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/info" method="post" class="form-horizontal"><%--
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="lbl">${user.mobile}&nbsp;&nbsp;<a href="${ctx}/sys/user/updateTelephone">修改</a></label>

			</div>
		</div>
        <div class="control-group">
            <label class="control-label">已绑定邮箱:</label>
            <div class="controls">
				<label class="lbl">${user.email}&nbsp;&nbsp;<a href="${ctx}/sys/user/updateEmail">修改</a></label>
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="lbl">010-82825235</label>
			</div>
		</div>
		<%--
		<div class="control-group">
		...
		<div class="form-actions">
			<a class="btn btn-primary" href="${ctx}/sys/user/modifyPwd">修改密码</a>
			<%--<input id="" class="btn btn-primary" type="button" value="修改密码"/>--%>
		</div>
	</form:form>
</body>
</html>