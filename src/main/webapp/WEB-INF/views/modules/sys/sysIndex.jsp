...
<head>
	...
	<script type="text/javascript">
			...
			$("#menu a.menu").click(function(){
				...
				if ($(menuId).length > 0){
					...
					if (!$(menuId + " .accordion-body:first").hasClass('in')){
						$(menuId + " .accordion-heading:first a")[0].click();
					}
					...
					$.get($(this).attr("data-href"), function(data){
						...
						// 默认选中第一个菜单
                        if($(menuId + " .accordion-heading").hasClass("accordion-yyl")){
                            $(menuId + " .accordion-heading a")[0].click();
						}else{
                            $(menuId + " .accordion-heading a")[0].click();
							$(menuId + " .accordion-body a:first i").click();
							$(menuId + " .accordion-body li:first li:first a:first i").click();
		...
		function choose(id){
            $("#select_menu").addClass("hidecontent");
            $("#content").removeClass("hidecontent");
            $("#menu").children(0).children(0)[id].click();
		}
        function addWindow(type) {
            if (type == 0) {
                $.jBox("iframe:${ctx}/sys/user/info", {
                    title: "个人中心",
                    width: 500,
                    height: 500,
                    buttons: {'关闭': true}
...
<body>
	<div id="main">
			...
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="userInfo" class="dropdown">
					    ...
					    <a class="dropdown-toggle" data-toggle="" href="#" onclick="addWindow(0);" title="个人信息">${fns:getUser().name}&nbsp;<span id="notifyNum" class="label label-info hide"></span></a>
					...
					<li><a href="${pageContext.request.contextPath}${fns:getAdminPath()}/" title="访问网站主页"><i class="icon-home"></i></a></li>
                    <li><a href="#" onclick="choose(5);" title="系统设置"><i class="icon-cog"></i></a></li>
					<li><a href="${ctx}/logout" title="退出登录"><i class="icon-off"></i></a></li>
					<li>&nbsp;</li>
				</ul>
	    ...
	    <div class="container-fluid">
            <div id="select_menu" class="row-fluid">
                <div class="container-fluid">
                    <div class="row-fluid show-grid">
                        <div class="span12">
                            <div class="span6 module">
                                <a href="#" onclick="choose(0);">有毒气体监测子系统</a>
                            </div>
                            <div class="span6 module">
                               <a href="#" onclick="choose(1);">视频监控子系统</a>
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid show-grid">
                        <div class="span12">
                            <div class="span6 module">
                                <a href="#" onclick="choose(2);">智慧跑道子系统</a>
                            </div>
                            <div class="span6 module">
                                <a href="#" onclick="choose(3);">能效监测子系统</a>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
			<div id="content" class="row-fluid hidecontent">
				<div id="left"><%--
