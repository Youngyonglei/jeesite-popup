...
import com.thinkgem.jeesite.modules.gym.entity.Collectortype;
...
public class RoleController extends BaseController {
	...
	@RequiresPermissions("gym:collectortype:view")
	@RequestMapping(value = {"list", ""})
	public String list(Role role, Model model) {
		List<Role> list = systemService.findPage(role);
	...
	public String save(Role role, Model model, RedirectAttributes redirectAttributes) {
		...
		if(systemService.getRole(role.getId())!=null){
			return "true";
		}else {
			return "false";
		}
